...
public class JSONListConverter {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Define List which will be converted to JSON
        ...
        String listToJson = objectMapper.writeValueAsString(personList);
        ...
        TypeReference<List<Person>> listTypeReference = new TypeReference<List<Person>>() {
        };

        List<Person> jsonToPersonList = objectMapper.readValue(listToJson, listTypeReference);
        System.out.println("\n2. Convert JSON to List of person objects :");
